...
mod tests {
    ...
    #[test]
    fn enum_invalid_field_recognizes_limit_type_top_level() {
        assert_eq!(enum_invalid_field("limit_type"), "limit_type");
    }

    #[test]
    fn enum_invalid_field_keeps_existing_payload_prefix_behavior() {
        assert_eq!(enum_invalid_field("payload.model"), "model");
        assert_eq!(enum_invalid_field("payload.region"), "region");
    }
