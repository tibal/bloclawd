            ...
            for submission_idx in 0..submissions_per_cohort {
                ...
                rows.push(EventRow {
                    ...
                    payload: EventPayload {
                        ...
                        tokens: TokenCounts {
                            input_tokens: base * 8,
                            output_tokens: base * 2 + 83,
                            cache_read_input_tokens: base * 4 + 127,
                            ephemeral_5m_input_tokens: base + 43,
                            ephemeral_1h_input_tokens: base / 3 + 11,
                            cached_input_tokens: base * 4 + 127,
                            reasoning_output_tokens: base / 4 + 17,
                        },
                    },
