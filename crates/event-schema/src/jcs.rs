...
//! Mirrors crates/pow/src/lib.rs:81-84 (which keeps its inline call until Phase 2
//! refactors pow to consume this helper).
...
/// dry-run printer (Phase 3) - same bytes, single source.
