...
Plan 01.5-03 deployed this pattern to staging at `https://bloclawd-worker-staging.thibault-dalmon.workers.dev/db-ping` and repeated smoke requests returned `{"ok":true}`.
